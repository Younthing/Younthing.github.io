...
- [Code of conduct](https://github.com/Younthing/jekyll-theme-chirpy/blob/master/docs/CODE_OF_CONDUCT.md)
- [Security policy](https://github.com/Younthing/jekyll-theme-chirpy/blob/master/docs/SECURITY.md)
- [How To Ask Questions The Smart Way][ext-reading]

[latest-ver]: https://github.com/Younthing/jekyll-theme-chirpy/releases/latest
[wiki]: https://github.com/Younthing/jekyll-theme-chirpy/wiki
[issues]: https://github.com/Younthing/jekyll-theme-chirpy/issues?q=is%3Aissue
[pr]: https://github.com/Younthing/jekyll-theme-chirpy/pulls
[discus]: https://github.com/Younthing/jekyll-theme-chirpy/discussions
...
[bug-report]: https://github.com/Younthing/jekyll-theme-chirpy/issues/new?assignees=&labels=&projects=&template=bug_report.yml
[feat-request]: https://github.com/Younthing/jekyll-theme-chirpy/issues/new?assignees=&labels=enhancement&projects=&template=feature_request.yml
[feat-creep]: https://en.wikipedia.org/wiki/Feature_creep
[dev-env]: https://github.com/Younthing/jekyll-theme-chirpy/wiki/Development-&-Test-Environments
